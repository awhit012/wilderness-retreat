    ...
    <div>
    	...
    	<div class="container">
    		<p>
				...
				<ul>
					<li>12 Nights guided canoe camping</li>
					<li>Fire ceremonies</li>
					<li>Sweat Lodge</li>
					<li>All meals included</li>
					<li>Canoe, paddle, life jacket rentals</li>
					<li>Night stay in Timmins the night before launch</li>
				...
				<p>To register email Alex: alexwhite5d@protonmail.com</p>
				<p>He will send you all of the details.</p>
				</div>
	    </div>	
    );
  }
